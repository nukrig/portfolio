...
import natsnaviScreenShot from "../../assets/natsnaviScreenShot.png";
  ...
  return (
    <div className="container">
      ...
      <div className="project-container">
        {/* PROJECT -3*/}
        <ProjectCard
          img={natsnaviScreenShot}
          view="https://natsnavi.ge"
          source="https://github.com/nukrig/natsnavi"
          heading="online store"
          paragraph="A fully functional, real-world e-commerce project built with Angular, featuring a dynamic and interactive 
          user experience. This project is fully responsive and demonstrates my skills in building modern web applications 
          with practical e-commerce functionality, including integrated online payments, product management, and many other features. "
        />
        {/* PROJECT -2*/}
        <ProjectCard
          img={angularMarkUp}
