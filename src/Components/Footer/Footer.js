            ...
            <div className='footer-container'>
                <div className='left'>
                    <div className='location'>
                        <FaHome size={20} style={{color:'yellowgreen',marginRight:'1rem'}} />
                        <div>
                            <p> Georgia, Tbilisi</p>
                        </div>
                    </div>
                    <div className='phone'>
                        <h4><FaPhone size={20} style={{color:'yellowgreen',marginRight:'1rem'}} />
                        <a href={`tel:${+995551116540}`}>551 11 65 40</a>
                        </h4>
                    </div>
                    <div className='email'>
                        <h4><FaMailBulk size={17} style={{color:'yellowgreen',marginRight:'0.9rem'}} />
                        <a href={`mailto:${'nukrigegelashvili3@gmail.com'}`}>nukrigegelashvili3@gmail.com</a>
                        </h4>
                    </div>
                </div>
                <div className='right'>
                    <h4 style={{fontSize:40,color:'yellowgreen'}}>...</h4>
                    ...
                    <div className='social'>
                        <a href='https://www.facebook.com/nukri.gegelashvili/' target='blank'>
                            <FaFacebook size={30} style={{color:'blue',marginRight:'1rem'}} className='pointer' />
                        </a>
                        <a href='https://instagram.com/nukri.g?igshid=YmMyMTA2M2Y=' target='blank'>
                            <FaInstagram size={30} style={{color:'orange',marginRight:'1rem'}} className='pointer'  />
                        </a>
                        ...
                        <a href='https://www.linkedin.com/in/nukri-gegelashvili-273505225' target='blank'>
                            <FaLinkedin size={30} style={{color:'blue',marginRight:'1rem'}} className='pointer'  />
                        </a>
